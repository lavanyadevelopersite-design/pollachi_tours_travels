...
User.hasMany(Agent, { foreignKey: 'created_by', as: 'agents' });

Corporate.belongsTo(User, { foreignKey: 'created_by', as: 'creator' });
User.hasMany(Corporate, { foreignKey: 'created_by', as: 'corporates' });
...
EnquiryNote.belongsTo(LeadStatus, {
...
Enquiry.hasMany(WhatsAppMessage, {
  foreignKey: 'enquiry_id',
  as: 'whatsappMessages',
  constraints: false,
});
