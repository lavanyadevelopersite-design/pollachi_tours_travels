...
} = require('../validators/corporate.validator');
const {
...
mountCrud('agents', 'agents', masterController.agents, {
  createSchema: createAgentSchema,
  updateSchema: updateAgentSchema,
  statusHandler: masterController.agentStatus,
});
mountCrud('corporates', 'corporates', masterController.corporates, {
  createSchema: createCorporateSchema,
  updateSchema: updateCorporateSchema,
  statusHandler: masterController.corporateStatus,
});
