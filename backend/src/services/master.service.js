...
const currencyService = {
  ...
  create: async (payload, userId = null) => {
    const data = normalizeOptionalFields(payload, ['description']);
...
const assertUniqueDepartment = async ({ department_name, department_code }, excludeId = null) => {
  ...
  const codeWhere = { department_code };
  if (excludeId) {
...
const departmentService = {
  ...departmentBase,
  create: async (payload, userId = null) => {
    const data = normalizeOptionalFields(payload, ['department_head', 'description', 'display_order']);
