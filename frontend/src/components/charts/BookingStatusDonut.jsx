...
function SlicePercentLabel({ cx, cy, midAngle, innerRadius, outerRadius, payload }) {
  const pct = Number(payload?.value);
  ...
  return (
    <text
      ...
      fontSize={pct >= 12 ? 11 : 9}
      fontWeight={800}
      style={{ pointerEvents: 'none', textShadow: '0 1px 2px rgba(15,23,42,0.45)' }}
    >
      {pct}%
    </text>
  );
