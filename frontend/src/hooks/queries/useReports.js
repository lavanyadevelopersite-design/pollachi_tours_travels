...
export const useMisReport = (params) => usePagedReport('mis', reportService.mis, params);
export const useToursReport = (params) => usePagedReport('tours', reportService.tours, params);
