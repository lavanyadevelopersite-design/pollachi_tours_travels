    ...
    >
      ...
      >
        <Box sx={{ minWidth: 0, width: '100%' }}>
          <Typography fontWeight={700} fontSize={14.5} color={style.color} sx={{ wordBreak: 'break-word' }}>
            {event.title}
          </Typography>
          {isVehicle && (
            <Box sx={{ mt: 0.4 }}>
          ...
          <Typography variant="body2" color={style.color} sx={{ opacity: 0.85, mt: 0.25, wordBreak: 'break-word' }}>
            {event.subtitle}
          </Typography>
        </Box>
      ...
      <Stack spacing={0.6} mt={1.25} sx={{ color: style.color }}>
        ...
        {event.notes && (
          <Typography
            ...
            gap={0.75}
            sx={{ opacity: 0.9, wordBreak: 'break-word' }}
          >
    ...
    >
      <DialogTitle sx={{ px: { xs: 2, sm: 3 }, pt: { xs: 2, sm: 2.5 }, pb: 1.5 }}>
        <Stack direction="row" alignItems="flex-start" justifyContent="space-between">
          <Box>
            <Typography variant="h5" fontWeight={800} lineHeight={1.2} sx={{ fontSize: { xs: 22, sm: 24 } }}>
      ...
      <DialogContent sx={{ px: { xs: 2, sm: 3 }, pb: { xs: 3, sm: 3 }, pt: 1 }}>
        {!events.length ? (
          <Stack
            alignItems="center"
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" sx={{ px: 2, textAlign: { xs: 'center', sm: 'left' } }}>
