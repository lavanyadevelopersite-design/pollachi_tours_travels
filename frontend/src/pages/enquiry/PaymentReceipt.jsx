      ...
      >
              ...
              {receipt.additionalCharges > 0 && (
                <>
                  <InfoRow
                    ...
                    value={formatInr(receipt.additionalCharges)}
                    valueColor="#7c3aed"
                    labelWidth={160}
                  />
                  <InfoRow
                    label="Total Received"
                    value={formatInr(receipt.receivedTotal)}
                    valueColor="#1565c0"
                    labelWidth={160}
                  />
                </>
        ...
        >
          <Typography variant="body2" sx={{ color: '#1e293b', lineHeight: 1.7 }}>
            ...
            a sum of{' '}
            <Box component="span" fontWeight={800} sx={{ color: GREEN }}>
              {formatInr(receipt.receivedTotal)} ({amountToIndianWords(receipt.receivedTotal)})
            </Box>{' '}
            towards{' '}
