...
export default function ItineraryGenerator() {
  ...
  const { data: linkedEnquiry } = useEnquiry(!isEdit ? enquiryId : null);
  ...
  useEffect(() => {
    if (isEdit || !linkedEnquiry) return;
    if (linkedEnquiry.travel_from) {
      setValue('fromDate', dayjs(linkedEnquiry.travel_from).format('YYYY-MM-DD'));
    }
    if (linkedEnquiry.travel_to) {
      setValue('toDate', dayjs(linkedEnquiry.travel_to).format('YYYY-MM-DD'));
    }
  }, [isEdit, linkedEnquiry, setValue]);
