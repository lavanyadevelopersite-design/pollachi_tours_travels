...
import { useDepartments, useDepartmentMutation } from '../../hooks/queries/useMasters';
...
export default function DepartmentList() {
  ...
  const { data, isLoading } = useDepartments(listParams);
  const { remove, updateStatus } = useDepartmentMutation();
          ...
          <Box>
            {canEdit && (
              <Tooltip title="Edit"><IconButton
                  ...
                  onClick={() => navigate(`/masters/departments/edit/${row.id}`)}
                >
  ...
  return (
    <Box>
      <PageHeader
        ...
        onAction={() => navigate('/masters/departments/create')}
      />
      <DataTable
        title="Departments"
        columns={columns}
