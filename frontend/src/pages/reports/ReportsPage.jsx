...
const REPORTS = [
  { title: 'Tours', path: '/reports/tours', icon: TourOutlinedIcon, color: '#2563eb' },
  { title: 'MIS', path: '/reports/mis', icon: TableChartOutlinedIcon, color: '#1d4ed8' },
  ...
  { title: 'Attendance', path: '/reports/attendance', icon: FactCheckOutlinedIcon, color: '#475569' },
];
