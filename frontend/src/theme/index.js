  ...
  components: {
    MuiCssBaseline: {
      styleOverrides: {
        ...
        'input, textarea, select, option, .MuiInputBase-input, .no-capitalize, .no-capitalize *': {
    ...
    MuiInputLabel: {
      styleOverrides: {
        root: { fontWeight: 500, textTransform: 'capitalize' },
      },
    },
    MuiAutocomplete: {
      styleOverrides: {
    ...
    MuiChip: {
      styleOverrides: {
        root: { borderRadius: 8, fontWeight: 600, fontSize: '0.75rem', textTransform: 'capitalize' },
        colorSuccess: {
