...
export default function EnquiryInvoiceView() {
  ...
  const invoice = useMemo(() => {
    ...
    if (isDirect) {
      ...
      travelFrom = quotation?.travel_from || enquiry.travel_from;
      travelTo = quotation?.travel_to || enquiry.travel_to;
      ...
      packageTitle =
        ...
        itinerary.title ||
        'Tour Package';
      travelFrom = quotation?.travel_from || enquiry.travel_from || itinerary.from_date;
      travelTo = quotation?.travel_to || enquiry.travel_to || itinerary.to_date;
    ...
    const totalInvoice = roundOffAmount(totalBeforeRound);
    const roundOff = round2(totalInvoice - totalBeforeRound);
    ...
    const customerAddress = [enquiry.city?.name, enquiry.state?.name, enquiry.country?.name]
      .filter(Boolean)
      .join(', ');
